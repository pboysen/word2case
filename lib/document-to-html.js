...
function DocumentConversion(options, comments) {
    ...
    function ParagraphStyleWithAttributes(attributes) {
    ...
    function htmlPathForParagraph(element, messages) {
        ...
        if (style) {
            ...
            if (element.alignment) 
            	return ParagraphStyleWithAttributes({style: `text-align: ${element.alignment};`});
            else
    ...
    function convertTableRow(element, messages, options) {
        ...
        return [
            Html.freshElement("tr", { style: `height: ${element.height};` }, [Html.forceWrite].concat(children))
        ];
    }
    ...
    function convertTableCell(element, messages, options) {
        ...
        var children = convertElements(element.children, messages, options);
        var style = `width: ${element.width};`;
        if (element.alignment) style += ` text-align: ${element.alignment};`;
    ...
    function htmlPathForBreak(element) {
        ...
        if (style) {
            ...
            return htmlPaths.topLevelElement("page");
        } else {
            return htmlPaths.empty;
        }
    }
