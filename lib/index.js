...
var pcType = {
  ...
  "31b4354eabcfd662fdfa2484b08dc58d": textareaElement(pcName()),
  "3014787d562730c8e3131967ada5f24d": selectElement(pcName())
};
...
function transform(html) {
  ...
  return replacements.reduce(function (result, repl) {
    return result.replaceAll(repl.from, repl.to);
  }, result);
}
